...
import edu.esprit.pidev.adapters.adapterStat.StatRoleTableModel;
...
public class StatComptePanel extends JPanel {

    private static JFXPanel chartFxPanel;
    private static StatRoleTableModel tableModel;
    private Chart chart;

    public StatComptePanel() {
        revalidate();
        repaint();
        tableModel = new StatRoleTableModel();
    ...
    private BarChart createBarChart() {
        ...
        xAxis.setLabel("Les Roles ");

        double tickUnit = tableModel.getTickUnit();

        NumberAxis yAxis = new NumberAxis();
        yAxis.setTickUnit(1);
        yAxis.setLabel("Nombre d'utilisateur par role");
