...
public class StatProjetPanel extends JPanel {

    private static JFXPanel chartFxPanel;
    private static StatCoursTableModel tableModel;
    private Chart chart;

    public StatProjetPanel() {
        revalidate();
        repaint();
        tableModel = new StatCoursTableModel();
    ...
    private BarChart createBarChart() {
        ...
        xAxis.setLabel("Les cours les plus visités");

        double tickUnit = tableModel.getTickUnit();

        NumberAxis yAxis = new NumberAxis();
        yAxis.setTickUnit(1);
        yAxis.setLabel("Nombre de visiteur par cours");
