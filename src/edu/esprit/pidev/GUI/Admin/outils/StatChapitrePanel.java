...
import edu.esprit.pidev.adapters.adapterStat.StatChapitreTableModel;
...
public class StatChapitrePanel extends JPanel {

    private static JFXPanel chartFxPanel;
    private static StatChapitreTableModel tableModel;
    private Chart chart;

    public StatChapitrePanel() {
        revalidate();
        repaint();
        tableModel = new StatChapitreTableModel();
    ...
    private BarChart createBarChart() {
        ...
        xAxis.setLabel("Les Titres des cours");

        double tickUnit = tableModel.getTickUnit();

        NumberAxis yAxis = new NumberAxis();
        yAxis.setTickUnit(1);
        yAxis.setLabel("Nombre de Chapitre par cours");
