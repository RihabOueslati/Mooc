...
import edu.esprit.pidev.adapters.adapterStat.StatForumTableModel;
...
public class StatForumPanel extends JPanel {

    private static JFXPanel chartFxPanel;
    private static StatForumTableModel tableModel;
    private Chart chart;

    public StatForumPanel() {
        revalidate();
        repaint();
        tableModel = new StatForumTableModel();
    ...
    private BarChart createBarChart() {
        ...
        xAxis.setLabel("Les sujets les plus visités");

        double tickUnit = tableModel.getTickUnit();

        NumberAxis yAxis = new NumberAxis();
        yAxis.setTickUnit(1);
        yAxis.setLabel("Nombre de Commentaire par sujet");
