 ...
 * @author Admin
 */
public class ContactConstruction {
    URL url;
    ...
    public void getMailMessage(final Mail mail,String adresse,String adressedis,String password) {
      this.adressedi=adressedis;
      this.pwd=password;
        try {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(adressedi, pwd);                            
}});
