 ...
 * @author jihene
 */
public class FormateurPanel extends javax.swing.JPanel {

    /**
     * Creates new form organismePanel
     */
    public FormateurPanel() {
        initComponents();
        jTableList.setModel(new FormateurAvalider());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Integer F1 = Integer.parseInt(jTableList.getValueAt(x, 0).toString());

        System.out.println("hh" + F1);
        GestionUtilisateur GU = new GestionUtilisateur();
        User user = GU.DisplayFormateur(F1);

        System.out.println(user);
        FormateurMap mp = new FormateurMap(user);
        mp.setVisible(true);
