...
import edu.esprit.pidev.dao.classes.nombreDAO;
import edu.esprit.pidev.dao.classes.statchapitreDAO;
 ...
 * @author Rihab
 */
public class StatNombreTableModel extends AbstractTableModel {
    ...
    public StatNombreTableModel() {

        nombreDAO sdao = new nombreDAO();
        data = sdao.GetNombreConnecte();
        names = sdao.GetStatut();
    }
