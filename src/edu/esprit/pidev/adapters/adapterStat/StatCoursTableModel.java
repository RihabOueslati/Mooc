 ...
 * @author Rihab
 */
public class StatCoursTableModel extends AbstractTableModel {
    ...
    public StatCoursTableModel() {

        StatCoursDAO sdao = new StatCoursDAO();
        data = sdao.GetStatCours();
        names = sdao.GetTitreCours();
    }
