...
import edu.esprit.pidev.dao.classes.khalilDAO;
 ...
 * @author Rihab
 */
public class StatRoleTableModel extends AbstractTableModel {
    ...
    public StatRoleTableModel() {

        khalilDAO sdao = new khalilDAO();
        data = sdao.GetNombre();
        names = sdao.GetRole();
    }
