 ...
 * @author Rihab
 */
public class StatChapitreTableModel extends AbstractTableModel {
    ...
    public StatChapitreTableModel() {

        statchapitreDAO sdao = new statchapitreDAO();
        data = sdao.GetNombreChapitre();
        names = sdao.GetTitre();
    }
