 ...
 * @author Rihab
 */
public class JTableModelCoursAttente extends AbstractTableModel {
    ...
    private String entete[]={"TITRE","Categorie","Description","Difficulté","Nombre des Chapitres"};
    
    private List<Cours> listcours=new ArrayList<Cours>();

    public JTableModelCoursAttente(User user) {
        CoursDAO cd = new CoursDAO();
       
        listcours =cd.DisplayAttente();
   
        
    }
    
    public JTableModelCoursAttente(List<Cours> listProjet) {
